...
(async function() {
  ...
  await loadScript('./js/VisualizationPatch.js');
  ...
  window.app=app; window.orderEngine=orderEngine; window.fundingSimulator=fundingSimulator; window.riskMetrics=riskMetrics; window.keyboardShortcuts=keyboardShortcuts;
  window.simulationEngine=simulationEngine; window.backtestEngine=backtestEngine; window.monteCarloEngine=monteCarloEngine; window.eventBus=eventBusInstance;
